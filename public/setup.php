...
.grp{font:800 11px/1 system-ui;letter-spacing:.09em;text-transform:uppercase;color:var(--mu);margin:26px 4px 12px;display:flex;align-items:center;gap:9px}
.grp::after{content:"";flex:1;height:1px;background:var(--bd)}
.grp:first-of-type{margin-top:6px}
.num{display:inline-grid;place-items:center;min-width:22px;height:22px;padding:0 6px;border-radius:6px;background:var(--ac);color:#fff;font:700 12px system-ui;flex:0 0 auto}
</style></head>
<body><div class="wrap">
<div class="topbar">
...
<div class="grp" data-i="grp_dash"></div>

<details class="step">
  <summary><span class="num">3</span> <span data-i="s2">Proyectos</span> <span class="opt" data-i="s2opt">— opcional</span></summary>
  <div class="body">
...
<details class="step">
  <summary><span class="num">6</span> <span data-i="s5c">Mensajes de contacto</span> <span class="opt" data-i="optonly">— opcional</span></summary>
  <div class="body">
...
const I18N={
 es:{title:'Instalación',intro:'Solo necesitás la <b>URL de tu GLPI</b> y <b>dos tokens</b>. Lo demás es opcional y ya tiene valores por defecto. Los campos de contraseña son de solo-escritura: dejalos vacíos para conservar lo guardado.',
  ...
  s2:'Proyectos',s2opt:'— opcional, ya funciona por defecto',l_ptype:'Tipo de proyecto',h_ptype:'Mostrar solo proyectos de este <b>«Tipo»</b> de GLPI. Vacío = todos.',
  ...
  s4:'Módulo Fichadas GPS',l_gpsen:'Activar el módulo de fichadas',l_gpslabel:'Etiqueta de la pestaña',l_gpsurl:'Link a la web de la app',h_gpsurl:'Se muestra como un botón dentro del módulo.',
 ...
 en:{title:'Setup',intro:'You only need your <b>GLPI URL</b> and <b>two tokens</b>. Everything else is optional and pre-filled. Password fields are write-only: leave blank to keep the stored value.',
  ...
  s2:'Projects',s2opt:'— optional, works by default',l_ptype:'Project type',h_ptype:'Only show projects of this GLPI <b>«Type»</b>. Empty = all.',
  ...
  s4:'GPS Check-ins module',l_gpsen:'Enable the check-ins module',l_gpslabel:'Tab label',l_gpsurl:'App website link',h_gpsurl:'Shown as a button inside the module.',
 ...
 fr:{title:'Installation',intro:'Il vous faut seulement l’<b>URL de votre GLPI</b> et <b>deux jetons</b>. Le reste est optionnel et pré-rempli. Les champs mot de passe sont en écriture seule : laissez vide pour conserver la valeur.',
  ...
  s2:'Projets',s2opt:'— optionnel, fonctionne par défaut',l_ptype:'Type de projet',h_ptype:'N’afficher que les projets de ce <b>«Type»</b> GLPI. Vide = tous.',
  ...
  s4:'Module Pointages GPS',l_gpsen:'Activer le module de pointages',l_gpslabel:'Libellé de l’onglet',l_gpsurl:'Lien du site de l’app',h_gpsurl:'Affiché comme un bouton dans le module.',
 ...
 de:{title:'Installation',intro:'Sie brauchen nur Ihre <b>GLPI-URL</b> und <b>zwei Tokens</b>. Der Rest ist optional und vorbelegt. Passwortfelder sind schreibgeschützt: leer lassen, um den Wert zu behalten.',
  ...
  s2:'Projekte',s2opt:'— optional, funktioniert standardmäßig',l_ptype:'Projekttyp',h_ptype:'Nur Projekte dieses GLPI-<b>«Typs»</b> zeigen. Leer = alle.',
  ...
  s4:'GPS-Check-ins-Modul',l_gpsen:'Modul aktivieren',l_gpslabel:'Tab-Beschriftung',l_gpsurl:'Link zur App-Website',h_gpsurl:'Wird als Button im Modul angezeigt.',
 ...
 pt:{title:'Instalação',intro:'Você só precisa da <b>URL do seu GLPI</b> e <b>dois tokens</b>. O resto é opcional e já vem preenchido. Campos de senha são de escrita apenas: deixe em branco para manter o valor.',
  ...
  s2:'Projetos',s2opt:'— opcional, já funciona por padrão',l_ptype:'Tipo de projeto',h_ptype:'Mostrar só projetos deste <b>«Tipo»</b> do GLPI. Vazio = todos.',
  ...
  s4:'Módulo Registros GPS',l_gpsen:'Ativar o módulo',l_gpslabel:'Rótulo da aba',l_gpsurl:'Link do site do app',h_gpsurl:'Exibido como um botão dentro do módulo.',
...
Object.assign(I18N.es,{grp_config:'Configuración',grp_dash:'Dashboards',grp_perso:'Personalización'});
Object.assign(I18N.en,{grp_config:'Configuration',grp_dash:'Dashboards',grp_perso:'Customization'});
